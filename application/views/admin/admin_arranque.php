...
Desde esta plataforma vas a poder plasmar en un mapa las campa&ntilde;as de v&iacute;a p&uacute;blica de tus clientes. 

<br /><br />Si necesitas dar de alta un cliente, contactate con el administrador.
                    <ul style="list-style: none;">
                        <?php foreach ($administradores as $ad){ ?>
                        <li><a href="mailto:<?php echo $ad->email; ?>"><?php echo $ad->email; ?></a></li]>
                        <?php } ?>
                    </ul>
