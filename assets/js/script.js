$(document).ready(function(){
	...
	//webcam.set_api_url('../../application/helpers/upload.php');	// The upload script
	dire=base+'admin/eventos/upload1';

	webcam.set_api_url(dire);	// The upload script
	...
	$('.botFoto').click(function(){

		id = $(this).attr('rel');
		id_invitado = $(this).attr('rel_inv');
		
		dire=base+'admin/eventos/upload1/'+id_invitado;
		$('#nombre').val('');
        $('#dni').val('');
        $('#id_externo').val('');
		var data = 'id='+id;
		$.ajax(
            {
                ...
                async:	true,
                type: "post",
                url: base+"admin/eventos/get_externo_by_id/"+id_invitado,
                dataType:"json",
...
*/
	...
	function loadPics(){
		...
		$.getJSON('../../application/helpers/browse.php',{'start':start},function(r){
